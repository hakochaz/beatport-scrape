...
var ArtistsFile = os.ExpandEnv("$GOPATH/pkg/github.com/hakochaz/beatport-scrape@v1.0.0/configs/artists.csv")
var OutputFile = os.ExpandEnv("$GOPATH/pkg/github.com/hakochaz/beatport-scrape@v1.0.0/output/tracks.json")
